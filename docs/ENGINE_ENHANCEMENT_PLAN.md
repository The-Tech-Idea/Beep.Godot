...
## Terrain rendering review and map gameplay features (2026-09-15). **Status: review and planning complete; implementation in progress — VIEW-14, VIEW-01, VIEW-02, VIEW-13, VIEW-04, VIEW-05, FEAT-09, FEAT-10 and FEAT-12 Implemented, VIEW-07 Partly implemented, 10 items Proposed. FIX-14, raised from the lab on 2026-09-16, landed the same day and is not accepted.**
...
| FEAT-14 | [Distance-from-start field, richness scaling and neutral sites](../plans/terrain-grid/FEAT-14-start-distance-and-neutral-sites.md) | feature | S–M | Proposed |
