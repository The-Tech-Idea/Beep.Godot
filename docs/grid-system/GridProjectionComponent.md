...
- `public Vector2 EffectiveTileSize` / `public Vector2 EffectiveOrigin` — sanitized (finite, tile size ≥ 1px, absolute-valued) versions of the raw exports, used internally instead of the raw values.
