...
| DUP-12 | [HUD panel base](../plans/terrain-grid/DUP-12-hud-panel-base.md) | duplication | M | **Partially implemented 2026-09-09** (six find-panels on GridPanelComponent + GridButtonBindings; toggle-bar/roster-cache pending) | **Mostly implemented 2026-09-09** (steps 1,2,4 + enum-parser; toggle-bar class-merge deferred) |
...
| ENH-14 | [Object-at-cell index](../plans/terrain-grid/ENH-14-object-at-cell-index.md) | enhancement + bug | S | Proposed | **Partially implemented 2026-09-09** (status late-source fix; object-at-cell index deferred) | **Partially implemented 2026-09-09** (status fix done; object-at-cell index investigated, declined as specified) |
| ENH-15 | [Unit and contract drift](../plans/terrain-grid/ENH-15-unit-and-contract-drift.md) | correctness / docs | XS–S | Proposed | **Partially implemented 2026-09-09** (ResourceCatalog index + case/space Find; unit renames pending) | **Implemented 2026-09-09** (unit renames + Find index; ForTerrain index skipped - no caller) |
