...
const KIT_BUTTON := preload("res://addons/beep_game_builder_cs/ecs/ui/kit/KitPushButton.cs")
...
const KIT_TOGGLE := preload("res://addons/beep_game_builder_cs/ecs/ui/kit/KitCheckButton.cs")
...
func _run() -> void:
	...
	_add(controls, host, KIT_BUTTON, "KitPushButton")
