...
try {
    ...
    $checks = @(
        ...
        "terrain_textures_load_probe.gd",
        "terrain_resource_scale_probe.gd",
        "terrain_start_scale_probe.gd",
        "terrain_scratch_lifetime_probe.gd",
        "terrain_erosion_diffusion_stability_probe.gd",
        "mountain_prefab_owner_probe.gd",
        "grid_ports_transfer_probe.gd",
        ...
        "terrain_chunk_load_abort_probe.gd",
